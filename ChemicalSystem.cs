...
namespace ChemicalHierarchy
{
    ...
    public class ChemicalSystem : IComparable<ChemicalSystem>, IComparable
    {
        ...
        /// название системы (это перечисление хим. элементов через тире, например, As-Ga)
        /// </summary>
        public string SystemNameNormalized
        {
            get {
                Normalize();
                return SystemName;
        ...
        /// </summary>
        /// <param name="el">массив химических элементов</param>
        public ChemicalSystem(params ChemicalElement[] el) 
            : this(false, el) { }

        /// <summary>
        /// конструктор (проверяется уникальность элементов в массиве)
        /// </summary>
        /// <param name="elements">массив химических элементов</param>
        public ChemicalSystem(params string[] elements) 
            : this(false, Array.ConvertAll(elements, x => new ChemicalElement(x))) { }

        /// <summary>
        /// конструктор (проверяется уникальность элементов в строке)
        /// </summary>
        /// <param name="system">строка, задающая систему "As-Ga"</param>
        public ChemicalSystem(string system)
            : this(system.Split(new char[] {'-'}, StringSplitOptions.RemoveEmptyEntries)) { }
        ...
        {
            return ((IComparable<ChemicalSystem>)this).CompareTo(obj as ChemicalSystem);
        }
        #endregion
    }
}
